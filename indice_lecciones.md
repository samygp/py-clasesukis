...
7. [Ciclos `for`: Parte 1](./mod_1/control_de_flujo/for_pt1.ipynb)
    - [Ciclos `for`: Práctica 1](https://repl.it/@elSenpai/for1)
    - [Ciclos `for`: Práctica 2](https://repl.it/@elSenpai/for2)
8. [Ciclos `for`: Parte 2](./mod_1/control_de_flujo/for_pt2.ipynb)
    - [Ciclos `for`: Práctica 3](https://repl.it/@elSenpai/for3)
    - [Ciclos `for`: Práctica 4](https://repl.it/@elSenpai/for4)
9. [Ciclos `while`](./mod_1/control_de_flujo/while.ipynb)
    - [Ciclos `while`: Práctica 1](https://repl.it/@elSenpai/while1)
    - [Ciclos `while`: Práctica 2](https://repl.it/@elSenpai/while1)